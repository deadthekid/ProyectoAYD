...
public class DataWebSecurity extends WebSecurityConfigurerAdapter{
	...
	.usersByUsernameQuery("SELECT usuario, contrasenia, 1 activo FROM USUARIOS where usuario=?")
	.authoritiesByUsernameQuery("select usuario, rol from USUARIOS "
	+ "where usuario = ?");
	}
